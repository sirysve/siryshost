...
<section class="testimonials">
    <div class="row">
        <div class="small-12 columns">
            ...
            <h2><span id="lovedby">0</span> RAZONES PARA ENAMORARTE DE SIRYSHOST</h2>
            <hr class="small"/>

            <div id="testimonials-carousel" class="owl-carousel">

                <div class="item">
                    <div class="whoclient"><span>Activación <a href="">Inmediata!</a></span></div>
                    <div class="testimonial-content">
                        <div class="testimonialimg"><?= $this->Html->image('hn-200x200.jpg') ?></div>
                        <p>Una vez culminado tu proceso de compra será activada de forma inmediata tu plan de hosting para que comiences con tu negocio en la Web</p>
                    </div>
                </div>

                <div class="item">
                    <div class="whoclient"><span>Soporte en <a href="">Español!</a></span></div>
                    <div class="testimonial-content">
                        <div class="testimonialimg"><?= $this->Html->image('jo-200x200.jpg') ?></div>
                        <p>Sabemos lo dificil de encontrar soporte en nuestro idioma por eso reciba respuestas efectivas a sus dudas completamente en español y desde cualquier lugar en el que se encuentre.</p>
                    </div>
                </div>

                <div class="item">
                    <div class="whoclient"><span>Pagas en <a href="">Bolívares!</a></span></div>
                    <div class="testimonial-content">
                        <div class="testimonialimg"><?= $this->Html->image('sm-200x200.jpg') ?></div>
                        <p>Siente la comodidad de pagar en Bolívares al adquirir nuestros servicios, gracias a la integración con Mercado pago y transferencia bancaria.</p>
                    </div>
                </div>
